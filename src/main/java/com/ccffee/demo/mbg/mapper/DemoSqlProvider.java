...
import com.ccffee.demo.mbg.model.DemoExample.Criteria;
import com.ccffee.demo.mbg.model.DemoExample.Criterion;
...
public class DemoSqlProvider {
    ...
    public String countByExample(DemoExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(DemoExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        DemoExample example = (DemoExample) parameter.get("example");
